...
namespace MPTranslator
{
    ...
    class Program
    {
        ...
        static void Dialog()
        {
            ...
            Console.WriteLine("Homomorphism ....................................... Enter 10");
            Console.WriteLine("SD_Translator ...................................... Enter 11");
            Console.WriteLine("-------------------------------------------------------------");
        }
        ...
        static void Execute()
        {
            ...
            Info();
            RemoveEpsilonRules();
            Console.WriteLine("После удаления е-продукций");
           ...
           // for (IEnumerator rule = Grammar.GetEnumerator(); rule.MoveNext(); )
            ...
            foreach (System.String rule in Grammar)
                Console.WriteLine(rule[0] + " -> " + rule.Substring(2, rule.Length-2));
        ...
        static void Main()
        {
            while (true)
            {
                ...
                switch (Console.ReadLine())
                {
                    ...
                    case "1":
                        myAutomate ka = new myAutomate(new ArrayList() { "S0", "A", "B", "C", "D", "E", "F", "qf" },
                                                       new ArrayList() { "0", "1", "-", "+", "" },
                                                       new ArrayList() { "qf" },
                                                       "S0");
                        ka.AddRule("S0", "1", "A");
                    ...
                    case "2":
                        ...
                        myAutomate ndka = new myAutomate(new ArrayList() { "S0", "A", "B", "C", "D", "E", "F", "qf" },
                                                         new ArrayList() { "1", "0", "+", "-" },
                                                         new ArrayList() { "qf" },
                                                         "S0");
                    ...
                    case "3":
                        /*myGrammar G = new myGrammar(new ArrayList() { "a", "b", "c", "d"},
                                                    new ArrayList() { "S", "A", "B", "C", "F", "A'", "C'" },
                                                    "S");

                        
                        G.AddRule("S", new ArrayList() { "c", "F", "C", "B" });
                        G.AddRule("A", new ArrayList() { "c", "C", "A'" });
                        G.AddRule("A", new ArrayList() { "c", "C" });
                        G.AddRule("A'", new ArrayList() { "C", "b", "A'" });
                        G.AddRule("A'", new ArrayList() { "C", "b" });
                        G.AddRule("B", new ArrayList() { "c", "B" });
                        G.AddRule("B", new ArrayList() { "" });
                        G.AddRule("C", new ArrayList() { "a" });
                        G.AddRule("C", new ArrayList() { "a", "C'" });
                        G.AddRule("C'", new ArrayList() { "a" });
                        G.AddRule("C'", new ArrayList() { "a", "C'" });
                        ...
                        G.AddRule("S", new ArrayList() { "c", "F", "C", "B" });
                        G.AddRule("A", new ArrayList() { "A", "C", "b" });
                        G.AddRule("A", new ArrayList() { "c", "C" });
                        G.AddRule("B", new ArrayList() { "c", "B" });
                        G.AddRule("B", new ArrayList() { "" });
                        ...
                        //myGrammar G4 = G.LeftRecursDelete();
                        //G4.DebugPrules();

                        myGrammar G4 = G.LeftRecursDelete();
                        G4.DebugPrules();
                        G4 = G4.unUsefulDelete();
                        G4.DebugPrules();
                    ...
                    case "4": //МП - автоматы
                        myGrammar kcGrammar0 = new myGrammar(new ArrayList() { "a", "c", "d" },
                                                            new ArrayList() { "S", "B", "C", "D", "F" },
                                                            "S");
                        ...
                        kcGrammar0.AddRule("S", new ArrayList() { "c", "F", "C", "B" });
                        kcGrammar0.AddRule("S", new ArrayList() { "c", "F", "C" });
                        kcGrammar0.AddRule("B", new ArrayList() { "c", "B" });
                        kcGrammar0.AddRule("B", new ArrayList() { "c" });
                        kcGrammar0.AddRule("C", new ArrayList() { "a" });
                        kcGrammar0.AddRule("C", new ArrayList() { "a", "D" });
                        kcGrammar0.AddRule("D", new ArrayList() { "a" });
                        kcGrammar0.AddRule("D", new ArrayList() { "a", "D" });
                        kcGrammar0.AddRule("F", new ArrayList() { "d" });

                        Console.Write("Debug KC-Grammar ");
                        kcGrammar0.DebugPrules();

                        myMp MP = new myMp(kcGrammar0);
                        Console.Write("Debug Mp ");
                        MP.debugDelta();
                    ...
                    case "4.1":
                        ...
                        myGrammar kcGrammar = new myGrammar(new ArrayList() { "a", "c", "d" },
                                                            new ArrayList() { "S", "B", "C", "D", "F" },
                                                            "S");

                        kcGrammar.AddRule("S", new ArrayList() { "c", "F", "C", "B" });
                        kcGrammar.AddRule("S", new ArrayList() { "c", "F", "C" });
                        kcGrammar.AddRule("B", new ArrayList() { "c", "B" });
                        kcGrammar.AddRule("B", new ArrayList() { "c" });
                        kcGrammar.AddRule("C", new ArrayList() { "a" });
                        kcGrammar.AddRule("C", new ArrayList() { "a", "D" });
                        kcGrammar.AddRule("D", new ArrayList() { "a" });
                        kcGrammar.AddRule("D", new ArrayList() { "a", "D" });
                        kcGrammar.AddRule("F", new ArrayList() { "d" });
                        ...
                        while (ans == "y")
                        {
                            ...
                            switch (Console.ReadLine())
                            {
                                case "1":
                                    ...
                                    myMp mpA1 = new myMp(new ArrayList() { "q0", "q", "qf"},
                                                         new ArrayList() { "a", "c", "d" },
                                                         new ArrayList() { "a", "c", "d", "S", "B", "C", "D", "F" },
                                                         "q0",
                                                         "S",
                                                         new ArrayList() { "qf" });

                                    mpA1.addDeltaRule("q0", "", "S", new ArrayList() { "q" }, new ArrayList() { "c", "F", "C", "B" });
                                    mpA1.addDeltaRule("q0", "", "S", new ArrayList() { "q" }, new ArrayList() { "c", "F", "C" });

                                    mpA1.addDeltaRule("q", "", "B", new ArrayList() { "q" }, new ArrayList() { "c" });
                                    mpA1.addDeltaRule("q", "", "B", new ArrayList() { "q" }, new ArrayList() { "c", "B" });

                                    mpA1.addDeltaRule("q", "", "C", new ArrayList() { "q" }, new ArrayList() { "a" });
                                    mpA1.addDeltaRule("q", "", "C", new ArrayList() { "q" }, new ArrayList() { "a", "D" });

                                    mpA1.addDeltaRule("q", "", "D", new ArrayList() { "q" }, new ArrayList() { "a" });
                                    mpA1.addDeltaRule("q", "", "D", new ArrayList() { "q" }, new ArrayList() { "a", "D" });

                                    mpA1.addDeltaRule("q", "", "F", new ArrayList() { "q" }, new ArrayList() { "d" });

                                    mpA1.addDeltaRule("q", "a", "a", new ArrayList() { "q" }, new ArrayList() { "" });
                                    mpA1.addDeltaRule("q", "c", "c", new ArrayList() { "q" }, new ArrayList() { "" });
                    ...
                    case "5.1": // LL Разбор
                        ...
                        exemple1.AddRule("L", new ArrayList() { "F" });
                    ...
                    case "7": //МП - автоматы
                        ...
                        // S->F@L 
                        // F->i L->i
                        myMp Mp = new myMp(new ArrayList() { "q0", "q" },
                                           new ArrayList() { "a", "b" },
                                           new ArrayList() { "z0", "a" },
                                           "q0",
                                           "S",
                        ...
                        Mp.addDeltaRule("q0", "e", "S", new ArrayList() { "q" }, new ArrayList() { "F", "@", "L" });
                        Mp.addDeltaRule("q", "e", "F", new ArrayList() { "q" }, new ArrayList() { "i" });
                        Mp.addDeltaRule("q", "e", "L", new ArrayList() { "q" }, new ArrayList() { "i" });
                        Mp.addDeltaRule("q", "i", "i", new ArrayList() { "q" }, new ArrayList() { "e" });
                        Mp.addDeltaRule("q", "@", "@", new ArrayList() { "q" }, new ArrayList() { "e" });
                        Console.Write("Debug Mp ");
                        Mp.debugDelta();
                        Console.WriteLine("\nEnter the line :");
                        Console.WriteLine(Mp.Execute(Console.ReadLine()).ToString());                       
