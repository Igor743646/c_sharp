...
namespace MPTranslator
{
    class Node
    {
        ...
        public void Create(ref mySDTSchemata SDT, ref ArrayList rules)
        {
        ...
        public void Transform(ref mySDTSchemata SDT, ref Node root)
        {
    ...
    class Tree
    {
        public mySDTSchemata SDT;
        public Node root;

        public Tree(mySDTSchemata sdt, ArrayList rules, string FS)
        {
            SDT = sdt;
            root = new Node(FS);
    ...
    class mySDTSchemata
    {
        ...
        public mySDTSchemata(ArrayList NTS, ArrayList IPTS, ArrayList OPTS, string FS)
        {
        ...
        public void TranslateByRules(ArrayList RulesNumbers)
        {
        ...
        private bool Recursive_descent_parser(ArrayList current_chain, ArrayList real_chain, int depth, ref ArrayList answer)
        {
        ...
        public ArrayList Derivation(ArrayList left_chain)
        {
            ArrayList s = new ArrayList();

            for (int i = 2; i < 20; i++)
            {
                bool flag = Recursive_descent_parser(new ArrayList() { FirstSymbol }, left_chain, i, ref s);
                if (flag)
                {
                    break;
                }
        ...
        public void Translate(ArrayList left_chain)
        {
            Console.WriteLine();
            Console.Write("Входная строка: ");
            Console.WriteLine(Utility.convert(left_chain));

            ArrayList s = Derivation(left_chain);
        ...
        public Tree CreateParseTree(ArrayList left_chain)
        {
            ArrayList s = Derivation(left_chain);
